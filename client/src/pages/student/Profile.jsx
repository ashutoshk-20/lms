...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if (isError) {
            toast.error(error.message || "Error in profile  updation")
        }
    }, [error, data, isSuccess, isError]);

    if (isLoading) return <h1 className='my-24'>Profile Loading...</h1>
                        ...
                        <DialogContent>
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Input type="file" name="profilepic" accept="image" className="col-span-3" onChange={(e) => onChangeHandler(e)} />
                                </div>
                                <div className="grid grid-cols-4 items-center gap-4">

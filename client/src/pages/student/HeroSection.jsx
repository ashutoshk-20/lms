...
const HeroSection = () => {
  return (
    <div className='relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-gray-800 dark:to-gray-900 py-24 px-4 text-center pb-10'>
        <div className='max-w-3xl mx-auto'>
            <h1 className='text-white text-4xl font-bold mb-4'>Find the best courses for you!</h1>
            <p className='text-gray-200 dark:to-gray-400 mb-8'>Discover, Learn, and Upskill with our wide range of courses</p>
